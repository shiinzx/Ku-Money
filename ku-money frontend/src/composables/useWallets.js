...
export function useWallets() {
  ...
  const handleSubmit = async (formData) => {
    try {
      ...
      if (error.code === 'NO_SUBSCRIPTION' || error.code === 'ACCOUNT_LIMIT_REACHED') {
        Swal.fire({
          icon: 'info',
          title: 'Batas Dompet Tercapai',
          text: 'Anda telah mencapai batas jumlah dompet untuk akun gratis. Silakan upgrade untuk menambah lebih banyak dompet.',
          showCancelButton: true,
          confirmButtonText: 'Lihat Paket Langganan',
